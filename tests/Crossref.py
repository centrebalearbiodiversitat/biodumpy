...
def test_download(query, summary):
	...
	if summary:
		...
		assert data['title'] == 'Climate change will redefine taxonomic, functional, and phylogenetic diversity of Odonata in space and time', "title is not Climate change will redefine taxonomic, functional, and phylogenetic diversity of Odonata in space and time"
		assert 'title' in data, "title is not in data"
		...
		assert 'title' in data, "title is not in data"
		assert data['title'][0] == 'Climate change will redefine taxonomic, functional, and phylogenetic diversity of Odonata in space and time', "title is not Climate change will redefine taxonomic, functional, and phylogenetic diversity of Odonata in space and time"
